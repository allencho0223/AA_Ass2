...
public class Config {
    ...
    public static String[] ATTRIBUTES = new String[] { "hairLength", "glasses", "facial", "eyeColor", "pimples", "hat",
            "hairColor", "noseShape", "faceShape" };

    public static List<String> ATTRIBUTE_LIST = Arrays.asList(ATTRIBUTES);
